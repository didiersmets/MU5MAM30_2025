...
/*on note tout les voisins à la manière d'adjacency*/
    ...
    dans P1 on n'en tenait pas compte et on s'en occupait avec la fonction find pendant la creation
    ...
    dans la matrice lorsque 2 triangles en ont une en commun.
